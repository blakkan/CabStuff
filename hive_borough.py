...
rdd = sqlContext.sql("FROM rides_yg SELECT *  WHERE pickup_longt IS NOT NULL AND pickup_lat IS NOT NULL")
sqlContext.sql('DROP TABLE rides_yg_with_boroug')
...
rdd3.saveAsTable('rides_yg_with_boroug');
