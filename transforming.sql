...
WHERE year(tpep_pickup_datetime) = 2016 and weekofyear(tpep_pickup_datetime) = 1
...
--select tpep_pickup_datetime, weekofyear(tpep_pickup_datetime) as pickup_week, from_unixtime(unix_timestamp(tpep_pickup_datetime),'EEEEE') as pickup_weekday  from yellow_rides_schema LIMIT 10;
